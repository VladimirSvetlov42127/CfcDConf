#include "dins_external_form.h"

#include <dpc/gui/widgets/TableView.h>

#include "gui/models/din_model.h"

DinsExternalForm::DinsExternalForm(DcController* controller) : DcForm(controller,  "Настройки внешних дискретных входов", false)
{
    auto dins = controller->signalManager().getSignals<DinSignal>(Signal::Subtype::Remote);
