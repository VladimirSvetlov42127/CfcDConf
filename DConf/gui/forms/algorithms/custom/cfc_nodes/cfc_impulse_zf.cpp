...
CfcImpulseZF::CfcImpulseZF(QString id, QSizeF node_size, QGraphicsItem* parent) : CfcNode(id, parent)
{
...
CfcImpulseZF::CfcImpulseZF(QDomNode xml, QGraphicsItem* parent) : CfcNode(xml, parent)
{
    //  Настройка параметров
    setName("ImpulseZF");
    setNodeType(RZA_IMPULSE_LEADING);
...
CfcImpulseZF::CfcImpulseZF(RamNode node, QGraphicsItem* parent) : CfcNode(node, parent)
{
    //  Настройка параметров
    setName("ImpulseZF");
    setNodeType(RZA_IMPULSE_LEADING);
...
void CfcImpulseZF::paintElement(QPainter* painter)
{
