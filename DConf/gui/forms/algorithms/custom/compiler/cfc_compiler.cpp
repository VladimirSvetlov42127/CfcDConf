...
//===================================================================================================================================================
bool CfcCompiler::compile(DepCfcParser *parser)
{
    connect(parser, &DepCfcParser::errorToLog, this, &CfcCompiler::onParserError);
    connect(parser, &DepCfcParser::infoToLog, this, &CfcCompiler::onParserInfo);
