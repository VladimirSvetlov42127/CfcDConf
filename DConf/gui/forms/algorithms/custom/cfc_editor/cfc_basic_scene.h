...
public:
    ...
    QList<RamNode> bufferNodes() const { return _buffer_nodes; }
    QList<RamLink> bufferLinks() const { return _buffer_links; }
...
//    QList<CfcLink*> _buffer_links;              //  Список связей для копирования
    //
    QList<RamNode> _buffer_nodes;               //  Список узлов для копирования
    QList<RamLink> _buffer_links;               //  Список связей для копирования
